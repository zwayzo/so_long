...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/12 02:34:35 by moazzedd          #+#    #+#             */
/*   Updated: 2022/12/17 23:50:32 by moazzedd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long.h"

void	set_up_right(t_long *so_long)
{
	...
	mlx_put_image_to_window(so_long->mlx, so_long->mlx_win,
		so_long->pac, so_long->pos_horizen,
		so_long->pos_vertic);
	ft_printf("move : %d\n", so_long->move);
	so_long->move++;
}
